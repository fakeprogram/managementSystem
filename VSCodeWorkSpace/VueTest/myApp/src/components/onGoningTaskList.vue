...
<template>
    <div style="width: 100%; height: 10%; margin-top: 20px;background-color: rgba(163, 171, 171,0.4);">
        <el-icon class="avatar-uploader-icon"><List />正在进行的任务</el-icon>
    </div>
    <el-scrollbar>
        <el-table empty-text="暂无数据" :data="taskData" style="width: 100%">
            ...
            <el-table-column prop="task.departmentName" label="部门" width="150" />
            <el-table-column prop="task.startTime" label="开始时间" width="300" />
            <el-table-column prop="task.taskType" label="类型" width="120" />
            <el-table-column prop="task.city" label="地点" width="130" />
            <el-table-column prop="task.taskProgress" label="进度/%" width="130" />
